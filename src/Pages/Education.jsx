        ...
        <div className="w-full lg:w-[35%] relative">
          ...
          >
            <iframe
              ...
              src="https://www.youtube.com/embed/_1B-Ek6JpM4"
      ...
      <div className="w-[95%] lg:w-[80%] m-auto mt-10 flex flex-col lg:flex-row gap-7">
        ...
        >
          ...
          <div className="p-5">
            ...
            <div className="mt-2 text-xl lg:text-2xl font-serif text-[#003C3C]">
              AI Edtech Dialogue Hosted by Reliance Foundation and Central
              Squa...
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-5">
            ...
            <div className="mt-2 text-xl lg:text-2xl font-serif text-[#003C3C]">
              Reliance Foundation announces results for its prestigious
              scholar...
            </div>
          </div>
        </motion.div>
