  ...
  return (
    <>
      ...
      className=" w-[80%] h-[500px] mt-36 m-auto rounded-3xl relative flex justify-center">
        <img
          src="https://www.reliancefoundation.org/sites/default/files/2024-01/Rectangle%204198.jpg"
          alt="rural"
        ...
        <div className="w-[83%] h-36 absolute bottom-10  z-10 flex items-center ">
          ...
          className="w-32 h-32 rounded-full bg-green-400 ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2023-11/edu-icon.png"
              alt="logo"
      ...
      <div className="w-[80%] h-[400px] m-auto mt-10 flex gap-7">
        ...
        className="w-[32%] h-full bg-white rounded-3xl hover:-translate-y-2">
          <div className="w-full h-[60%] ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2026-04/RFS%20Publication%20listing.png"
              alt="media img"
          ...
          <div className="p-5">
            ...
            <div className="mt-2 text-2xl font-serif text-[#003C3C]">
              Nurturing Aspirations, Celebrating Excellence
            </div>
          </div>
        </motion.div>
        ...
        className="w-[32%] h-full bg-white rounded-3xl hover:-translate-y-2">
          <div className="w-full h-[60%] ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2026-01/AI%20Impact%20summit%20cover.png"
              alt="media img"
              className="w-full h-full rounded-3xl rounded-b-none"
            />
          </div>
          <div className="p-5">
            ...
            <div className="mt-2 text-2xl font-serif text-[#003C3C]">
             AI Edtech Dialogue Hosted by Reliance Foundation and Central Squa...
            </div>
          </div>
        </motion.div>
        ...
        className="w-[32%] h-full bg-white rounded-3xl hover:-translate-y-2">
          <div className="w-full h-[60%] ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2025-12/Untitled%20design%20%289%29.png"
              alt="media img"
              className="w-full h-full rounded-3xl rounded-b-none"
            />
          </div>
          <div className="p-5">
            ...
            <div className="mt-2 text-2xl font-serif text-[#003C3C]">
              Reliance Foundation announces results for its prestigious scholar...
      ...
      <div className="w-[80%] h-[550px] m-auto mt-10 flex justify-between">
        ...
        className="w-[49%] h-full bg-white rounded-3xl p-9 relative cursor-pointer">
          <div className="w-full h-[50%] bg-gray-500 rounded-3xl ">
            ...
            whileHover={{ scale: 1.1 }}
              ...
              src="https://www.reliancefoundation.org/sites/default/files/2026-04/ECCE%20revised%20listing.png"
              alt="liveimg"
              className="w-full h-full rounded-3xl"
            />
          </div>
          ...
          className="w-24 h-24 flex items-center justify-center bg-[#C0EDD0] absolute top-56 left-56 rounded-full">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2023-10/edu_icon1.png"
              alt="live"
        ...
        className="w-[49%] h-full bg-white rounded-3xl p-9 relative cursor-pointer">
          ...
          <div className="w-full h-[30%] mt-24">
            <div className="text-3xl font-serif">Foundational Literacy and Numeracy</div>
