  ...
  return (
    <>
      ...
      className=" w-[80%] h-[500px] mt-36 m-auto rounded-3xl relative flex justify-center">
        <img
          src="https://www.reliancefoundation.org/sites/default/files/2025-04/Jyoti%20Cover.jpg"
          alt="rural"
        ...
        <div className="w-[83%] h-36 absolute bottom-10  z-10 flex items-center ">
          ...
          className="w-32 h-32 rounded-full bg-green-400 ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2024-01/sports-icon.png"
              alt="logo"
      ...
      className="mt-14 ml-40 text-6xl font-serif text-[#003C3C]">
        Latest on Sports for Development
      </motion.div>
      ...
      <div className="w-[80%] h-[400px] m-auto mt-10 flex gap-7">
        ...
        className="w-[32%] h-full bg-white rounded-3xl hover:-translate-y-2">
          <div className="w-full h-[60%] ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2026-01/United%20in%20Triumph.png"
              alt="media img"
          ...
          <div className="p-5">
            ...
            <div className="mt-2 text-2xl font-serif text-[#003C3C]">
             Mrs. Nita M Ambani: On behalf of every Indian, we are going to ho...
            </div>
          </div>
        </motion.div>
        ...
        className="w-[32%] h-full bg-white rounded-3xl hover:-translate-y-2">
          <div className="w-full h-[60%] ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2025-12/Rf%20shooters%20.png"
              alt="media img"
              className="w-full h-full rounded-3xl rounded-b-none"
            />
          </div>
          <div className="p-5">
            ...
            <div className="mt-2 text-2xl font-serif text-[#003C3C]">
             Army Marksmanship Unit, Mhow Signs MoU with Reliance Foundation t...
            </div>
          </div>
        </motion.div>
        ...
        className="w-[32%] h-full bg-white rounded-3xl hover:-translate-y-2">
          <div className="w-full h-[60%] ">
            <img
              src="https://www.reliancefoundation.org/sites/default/files/2025-09/lets-move_0.png"
              alt="media img"
              className="w-full h-full rounded-3xl rounded-b-none"
            />
          </div>
          <div className="p-5">
            ...
            <div className="mt-2 text-2xl font-serif text-[#003C3C]">
              Reliance Foundation Celebrates Olympic Day 2025 with Olympians De...
...
{/* 
      ...
      variants={fadeUp}
        initial="hidden"
        whileInView="visible"
        whileHover={{ scale: 1.01 }}className="w-[80%] m-auto h-[450px]  bg-[#C0EDD0] mt-12 rounded-3xl text-center">
