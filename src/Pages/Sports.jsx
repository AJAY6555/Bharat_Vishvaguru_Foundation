        ...
        <div className="w-full lg:w-[35%] relative">
          ...
          >
            <iframe
              ...
              src="https://www.youtube.com/embed/ZTBj6vb7JgQ"
      ...
      <div className="w-[95%] lg:w-[80%] m-auto mt-10 flex flex-col lg:flex-row gap-7">
        ...
        >
          ...
          <div className="p-5">
            ...
            <div className="mt-2 text-xl lg:text-2xl font-serif text-[#003C3C]">
              Mrs. Nita M Ambani: On behalf of every Indian, we are going to
              ho...
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-5">
            ...
            <div className="mt-2 text-xl lg:text-2xl font-serif text-[#003C3C]">
              Army Marksmanship Unit, Mhow Signs MoU with Reliance Foundation
              t...
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-5">
            ...
            <div className="mt-2 text-xl lg:text-2xl font-serif text-[#003C3C]">
              Reliance Foundation Celebrates Olympic Day 2025 with Olympians
              De...
            </div>
          </div>
        </motion.div>
