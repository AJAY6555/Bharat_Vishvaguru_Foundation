...
const publications = [
  {
    title:
      "A Decade of Doing More: Evaluating Development Interventions",
    image:
          ...
          <div className="max-w-7xl mx-auto px-6 w-full">
            ...
            >
              ...
              <p className="text-gray-200 text-xl leading-9 mt-8">
                Grounded in the ethos of “We Care,” Bharat Vishvaguru
                Foundation shares impactful stories, expert insights,
                and thought-provoking publications driving meaningful
                social development.
              </p>
      ...
      <div className="py-28">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 text-xl leading-9 mt-10">
            Discover compelling narratives and real-world impact stories
            from communities across India through our development
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-9 mt-8">
                Bharat Vishvaguru Foundation believes in sharing
                impactful stories, research insights and publications
                that encourage informed decisions and social innovation.
              </p>

              <p className="text-gray-600 text-lg leading-9 mt-6">
                Through our publications and narratives, we strive to
                amplify voices, inspire communities and drive sustainable
